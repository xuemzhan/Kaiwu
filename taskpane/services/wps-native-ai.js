...
(function () {
    ...
    var HINT = '请运行包内的 disable-wps-native-ai.bat 或 enable-wps-native-ai.bat 切换原生 WPS AI / 稻壳 的可见性。重启 WPS 后生效。';
    ...
    var WPSNativeAIStatus = {
        ...
        getRegistryKeys: function () {
            return REGISTRY_KEYS.map(function (e) { return { key: e.key, value: e.value, desc: e.desc }; });
        },

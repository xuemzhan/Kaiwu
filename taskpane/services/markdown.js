...
var KwMarkdown = (function () {
  ...
  var _renderer = null;
  var _markedAvailable = function () {
    return typeof window !== 'undefined' && typeof window.marked !== 'undefined';
  };
  var _kwSecurityAvailable = function () {
    return typeof window !== 'undefined' && typeof window.KwSecurity !== 'undefined';
  };
  ...
  function buildRenderer() {
    ...
    renderer.code = function (codeOrObj, language) {
      ...
      if (lang === 'svg' || lang === 'html') {
        return (
          '<div class="raw-preview"><pre><code>' + KwUtils.escapeHtml(code) + '</code></pre></div>'
        );
      }
    ...
    renderer.image = function (hrefOrObj, title, text) {
      ...
      return (
        '<img src="' +
        KwUtils.escapeAttr(safeHref) +
        '" alt="' +
        KwUtils.escapeAttr(altText) +
        '" title="' +
        KwUtils.escapeAttr(titleText) +
        '">'
      );
    };
    ...
    if (
      ...
      if (nodes.length > 0) {
        nodes.forEach(function (n) {
          n.setAttribute('data-mmd', 'pending');
        });
        try {
          ...
          if (promise && typeof promise.then === 'function') {
            promise.then(
              function () {
                nodes.forEach(function (n) {
                  n.setAttribute('data-mmd', '1');
                });
              },
              function () {
                nodes.forEach(function (n) {
                  n.setAttribute('data-mmd', 'error');
                });
              }
            );
          } else {
